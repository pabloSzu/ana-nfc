...
import {
  ...
  FiTag, FiThumbsUp, FiTruck, FiUsers, FiVideo, FiWifi, FiCalendar, FiClipboard,
  FiCreditCard, FiDollarSign, FiFileText, FiHeadphones, FiImage, FiMic, FiPackage,
  FiPlay, FiScissors, FiSend, FiShield, FiShoppingBag, FiSmile, FiSun, FiTool,
  FiTrendingUp, FiUser, FiZap,
} from "react-icons/fi";
...
export type IconCategory = "Popular" | "Compras" | "Contenido" | "Servicios" | "Otros";
export const CUSTOM_ICON_OPTIONS: { id: string; label: string; category: IconCategory; keywords?: string }[] = [
  { id: "star", label: "Estrella", category: "Popular" },
  { id: "heart", label: "Corazón", category: "Popular" },
  { id: "gift", label: "Regalo", category: "Popular" },
  { id: "location", label: "Ubicación", category: "Popular", keywords: "mapa dirección" },
  { id: "clock", label: "Horario", category: "Popular" },
  { id: "calendar", label: "Calendario", category: "Popular", keywords: "turnos reservas" },
  { id: "share", label: "Compartir", category: "Popular" },
  { id: "tag", label: "Precio", category: "Compras" },
  { id: "percent", label: "Descuento", category: "Compras", keywords: "oferta" },
  { id: "cart", label: "Carrito", category: "Compras", keywords: "tienda" },
  { id: "bag", label: "Bolsa", category: "Compras", keywords: "compra tienda" },
  { id: "ticket", label: "Entrada", category: "Compras", keywords: "evento" },
  { id: "creditcard", label: "Tarjeta", category: "Compras", keywords: "pago" },
  { id: "dollar", label: "Dinero", category: "Compras", keywords: "precio pago" },
  { id: "package", label: "Paquete", category: "Compras", keywords: "pedido" },
  { id: "truck", label: "Envío", category: "Compras" },
  { id: "camera", label: "Cámara", category: "Contenido", keywords: "foto" },
  { id: "video", label: "Video", category: "Contenido" },
  { id: "image", label: "Imagen", category: "Contenido", keywords: "galería foto" },
  { id: "music", label: "Música", category: "Contenido" },
  { id: "play", label: "Reproducir", category: "Contenido" },
  { id: "microphone", label: "Micrófono", category: "Contenido", keywords: "podcast audio" },
  { id: "headphones", label: "Auriculares", category: "Contenido", keywords: "audio" },
  { id: "book", label: "Menú/Libro", category: "Contenido" },
  { id: "document", label: "Documento", category: "Contenido", keywords: "archivo pdf" },
  { id: "download", label: "Descarga", category: "Contenido" },
  { id: "home", label: "Inicio", category: "Servicios" },
  { id: "briefcase", label: "Trabajo", category: "Servicios" },
  { id: "coffee", label: "Café", category: "Servicios" },
  { id: "utensils", label: "Comida", category: "Servicios", keywords: "restaurante" },
  { id: "car", label: "Auto", category: "Servicios" },
  { id: "scissors", label: "Tijeras", category: "Servicios", keywords: "peluquería" },
  { id: "tool", label: "Herramienta", category: "Servicios", keywords: "reparación" },
  { id: "clipboard", label: "Formulario", category: "Servicios" },
  { id: "users", label: "Comunidad", category: "Servicios" },
  { id: "user", label: "Persona", category: "Servicios", keywords: "perfil" },
  { id: "shield", label: "Protección", category: "Servicios", keywords: "seguridad" },
  { id: "award", label: "Premio", category: "Servicios" },
  { id: "info", label: "Info", category: "Otros" },
  { id: "help", label: "Ayuda", category: "Otros" },
  { id: "thumbsup", label: "Me gusta", category: "Otros" },
  { id: "lock", label: "Seguro", category: "Otros" },
  { id: "wifi", label: "WiFi", category: "Otros" },
  { id: "flag", label: "Bandera", category: "Otros" },
  { id: "bell", label: "Aviso", category: "Otros" },
  { id: "send", label: "Enviar", category: "Otros" },
  { id: "smile", label: "Sonrisa", category: "Otros" },
  { id: "sun", label: "Sol", category: "Otros" },
  { id: "growth", label: "Crecimiento", category: "Otros" },

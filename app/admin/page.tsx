...
export default async function Admin({ searchParams }: { searchParams: Promise<{ error?: string; success?: string; saved?: string }> }) {
  ...
  if (!claims?.claims) return <main className="shell login-shell"><Link className="btn" href="/admin/login">Ingresar</Link></main>;

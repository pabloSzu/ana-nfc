...
// Only for the handwritten margin notes in the makers section (app/_home/makers.tsx).
export const hand = Caveat({ subsets: ["latin"], weight: ["600"], variable: "--bx-hand", display: "swap" });

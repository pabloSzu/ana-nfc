...
const STEPS = [
  { number: "01", title: "Elegís el formato",
  ...
  { number: "02", title: "Acercás el celular",
  ...
  { number: "03", title: "Se abre tu página",
  ...
  { number: "04", title: "La conexión sucede",
            ...
            <li className="bx-process-step" key={step.number} style={{ "--step-index": index } as CSSProperties}>
              <article className="bx-process-card" aria-labelledby={`how-step-${step.number}`}>
                <div className="bx-process-image">
                  <Image src={step.image} alt={step.alt} fill sizes="(max-width: 600px) calc(100vw - 40px), (max-width: 1099px) calc((100vw - 88px) / 2), (max-width: 1439px) calc((100vw - 136px) / 4), 318px" />
                </div>
